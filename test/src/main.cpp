...
#define DEFRET_777_1 printf ("ret %s \n",__func__), 
#define DEFRET_777_2 {printf ("ret %s \n",__func__); 
#define DEFRET_777_3 } 
#endif
# 1 "/home/alex/Downloads/llvm/tools/clang/tools/example/test/src/main.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/alex/Downloads/llvm/tools/clang/tools/example/test/src/main.cpp" 2



# 1 "/home/alex/Downloads/llvm/tools/clang/tools/example/test/include/test.h" 1
extern "C" {int bar ();}
extern "C" {void foo();}
...
public:
  ...
  int test_method (int a) { DEFBEG_777  if (a > 0) return DEFRET_777_1  1; else return DEFRET_777_1  0; DEFEND_777 }
  int test_method (int a, int b) { DEFBEG_777 return DEFRET_777_1  1; DEFEND_777 }
  int hello();
  bool getVar() const { DEFBEG_777 return DEFRET_777_1  !var; DEFEND_777 }
};
# 6 "/home/alex/Downloads/llvm/tools/clang/tools/example/test/src/main.cpp" 2
...
{ DEFBEG_777 
  ...
  int b = 1;
  printf ("b = %d\n\r", b );
  return DEFRET_777_1  printf ("Hello World"), (1);
